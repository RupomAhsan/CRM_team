...
namespace CRM_team.EntityFramework.Repositories
{
    ...
    /// </summary>
    public class TaskRepository : CRM_teamRepositoryBase<Task, long>, ITaskRepository
    {
        public TaskRepository(IDbContextProvider<CRM_teamDbContext> dbContextProvider)
